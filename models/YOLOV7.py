...
class YOLOV7(nn.Module):
    def __init__(self, C=80, strides=(), reg_max=16, training=True):
        ...
        self.iv6_detect = IV6Detect(nc=C, ch=(256, 512, 1024), strides=self.strides,
                                    reg_max=self.reg_max, training=training)
    ...
    def forward(self, x):
        ...
        return self.iv6_detect([x_75, x_88, x_101])
